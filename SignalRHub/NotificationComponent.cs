    ...
    public class NotificationComponent
    {
        public void RegisterNotification(DateTime currentTime)
        {
          ...
          //  ALTER DATABASE[yourdatabasename] SET ENABLE_BROKER WITH ROLLBACK IMMEDIATE;  //
            ...
            string sqlCommand = @"SELECT [ID],[CustName],[CustEmail] from [dbo].[Customers] where [AddedOn] > @AddedOn";
        ...
        void sqlDep_OnChange(object sender, SqlNotificationEventArgs e)
        {
            ...
            if (e.Type == SqlNotificationType.Change)
            {
                ...
                var notificationHub = GlobalHost.ConnectionManager.GetHubContext<CustomerHub>();
